#!/usr/bin/env python3
"""Measure this aligner against the word-synced lyrics already in the cache.
...
Spicy Lyrics' cache is full of word-synced documents -- Apple Music's own
timings and community ones -- for songs this machine has played. They are not
