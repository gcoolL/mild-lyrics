# `mild-lyrics/eval_aligner.py`

Comments lifted out of `mild-lyrics/eval_aligner.py`. Docstrings stayed in the code, and so did tool directives (`noqa`, `pragma`, the shebang).
