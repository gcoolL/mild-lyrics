# `mild-lyrics/build_dataset.py`

Comments lifted out of `mild-lyrics/build_dataset.py`. Docstrings stayed in the code, and so did tool directives (`noqa`, `pragma`, the shebang).
