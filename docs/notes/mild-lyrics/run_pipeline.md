# `mild-lyrics/run_pipeline.py`

Comments lifted out of `mild-lyrics/run_pipeline.py`. Docstrings stayed in the code, and so did tool directives (`noqa`, `pragma`, the shebang).
