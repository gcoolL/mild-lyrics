# `aligner/genius_roman.py`

Comments lifted out of `aligner/genius_roman.py`. Docstrings stayed in the code, and so did tool directives (`noqa`, `pragma`, the shebang).
