# `aligner/eval_sources.py`

Comments lifted out of `aligner/eval_sources.py`. Docstrings stayed in the code, and so did tool directives (`noqa`, `pragma`, the shebang).
